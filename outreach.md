...
### Astrobites
{% include image-caption.html imageurl="/assets/images/posts/outreach/astrobites.png#right" caption="Alt text: The logo of Astrobites." width="400" %}
...
### KIT inclusion club
{% include image-caption.html imageurl="/assets/images/posts/outreach/kit.jpg#right" caption="ALt text: Me standing with my autistic friend, Abdullah, who I was performing with." width="30%" %}
...
{% include image-caption.html imageurl="/assets/images/posts/outreach/women.jpg#right" caption="Alt text: Three women wearing the same t-shirts representing women in the Physics department at Nazarbayev University. From left to right: Azel Murzabekova (the co-founder), Mary Iskakova, and me." width="400" %}
